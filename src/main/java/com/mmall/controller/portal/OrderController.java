...
public class OrderController {
    ...
    @ResponseBody
    public ServerResponse<Boolean> create(HttpServletRequest request, Integer shippingId){
    ...
    @ResponseBody
    public ServerResponse<String> cancle(HttpServletRequest request, Long orderNo){
        String loginToken = CookieUtil.readLoginToken(request);
        if(StringUtils.isEmpty(loginToken))
            return ServerResponse.createByErrorMessage("用户未登录，无法获取当前用户信息");
